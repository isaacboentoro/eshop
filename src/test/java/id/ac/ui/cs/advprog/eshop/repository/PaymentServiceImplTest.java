...
public class PaymentServiceImplTest {
    ...
    void testUpdateNonexistentPayment() {
        String nonexistentId = "woh";
        Payment payment = new Payment(nonexistentId, PaymentMethod.BY_TRANSFER.getValue(), PaymentStatus.REJECTED.getValue(), new HashMap<String, String>());
        doReturn(null).when(paymentRepository).findById(nonexistentId);

        assertThrows(NoSuchElementException.class, () -> {
            paymentService.setStatus(payment, nonexistentId);
        });
